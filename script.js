...
const PageManager = {
    ...
    initLessons() {
        ...
        const content = {
            ...
            "Piano": `<div class="two-column-layout"><div><p class="teacher-name">Anderson Jno Baptiste</p><img src="images/Lessons/Andy.png" style="width:150px;height:150px;"><p>(Jazz Piano)</p><ul style="text-align: left;"><li>fill in</li><li>fill in</li><li>fill in</li><li>fill in</li></ul></div><div><p class="teacher-name">Ninaad Raman</p><img src="images/Lessons/Ninaad.png" style="width:150px;height:150px;"><p>(Classical Piano)</p><ul style="text-align: left;"><li>15+ years of classical piano experience</li><li>Familiar with the Suzuki method</li><li>Teaches all ages</li><li>Teaches all skill levels</li><li>Wholistic approach to music education</li></ul></div></div><a href="contact.html"><img src="images/Lessons/inquire_base.png" style="width:100px;height:auto;" onmouseover="this.src='images/Lessons/inquire_hover.png'" onmouseout="this.src='images/Lessons/inquire_base.png'"></a>`,
            "Teachers": `<div class="two-column-layout"><div><p class="teacher-name" style="text-align:left;">Jacob Winthrop</p><img src="images/Lessons/Jacob.png" style="width:150px;height:150px;float:left;margin-right:15px;margin-bottom:10px;"><p>Jacob is a guitar player and drummer who graduated with a degree in professional music from Berklee College of Music, and has played for 12 years. His guitar teaching experience ranges from local kids in Los Angeles to full classes of adults in Boston and now he wants to teach you! He knows that every student is different and therefore every lesson should be approached differently. He loves music theory and uses it to help teach you how to not only be a great guitar player or drummer, but also a musician capable of self-teaching. Above all he wants you to believe in yourself and have fun! Music is all about fun!</p></div><div><p class="teacher-name" style="text-align:right;">Anderson Jno Baptiste</p><img src="images/Lessons/Andy.png" style="width:150px;height:150px;float:right;margin-left:15px;margin-bottom:10px;"><p>Raised in classical and choral traditions, Ninaad spent 15 years honing his skills on the piano and voice until beginning his studies at The Berklee College of Music. There, he developed an advanced understanding of music theory and composition as well as audio engineering through his double major in Film Scoring and Music Production/Engineering. During this time he picked up the Bass Guitar and developed a love for Funk and Jazz styles. He spent his life both as a student and teacher, mentoring younger students in his choir and developing piano and guitar skills in others around his community.</p></div></div><div style="text-align:center;max-width:500px;margin:20px auto 0;"><p class="teacher-name">Ninaad Raman</p><img src="images/Lessons/Ninaad.png" style="width:150px;height:150px;display:block;margin:0 auto 10px;"><p>Raised in classical and choral traditions, Ninaad spent 15 years honing his skills on the piano and voice until beginning his studies at The Berklee College of Music. There, he developed an advanced understanding of music theory and composition as well as audio engineering through his double major in Film Scoring and Music Production/Engineering. During this time he picked up the Bass Guitar and developed a love for Funk and Jazz styles. He spent his life both as a student and teacher, mentoring younger students in his choir and community with an emphasis on a fun and supportive learning environment.</p></div><a href="contact.html"><img src="images/Lessons/inquire_base.png" style="width:120px;height:auto;" onmouseover="this.src='images/Lessons/inquire_hover.png'" onmouseout="this.src='images/Lessons/inquire_base.png'"></a>`
        };
